...
const snapshot: TrainingSessionSnapshot = {
  ...
  commands: [{ id: 'command', errorEventId: 'left', command: 'FEEDBACK_ERROR', sentAt: 1_020, status: 'sent' }],
...
describe('TrainingReport', () => {
  ...
  it('exports the unchanged serializable snapshot only when the secondary action is clicked', () => {
