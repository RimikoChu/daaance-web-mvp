...
import { PodConnectionPanel } from './components/PodConnectionPanel'
  ...
  return <main className="home page-shell">
    ...
    <section className="hero">
      <div className="hero-copy">
        ...
        <PodConnectionPanel onReady={() => setPodsReady(true)} />
        <button className="primary giant" onClick={onStart} disabled={!podsReady}>继续设置 <ChevronRight size={20} /></button>
